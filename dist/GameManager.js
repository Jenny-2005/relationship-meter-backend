...
export class GameManager {
    ...
    removeUser(socket) {
        ...
        this.games = this.games.filter(game => game.player1 !== socket &&
            game.player2 !== socket);
        // Handle room cleanup
        ...
        socket.on("message", data => {
            ...
            if (message.type === "SUBMIT_AVATAR") {
                ...
                if (room.player1.avatar && player2.avatar) {
                    const game = new Game(room.player1.socket, player2.socket, questions, room.player1.avatar, player2.avatar);
